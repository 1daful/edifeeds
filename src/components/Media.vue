      ...
      <q-card class="col-2 myCard" v-for="mediaItem in media" :key="mediaItem.id">
        ...
        <q-card-section v-if="mediaItem">
          ...
          >
            ...
            <q-item-label class="caption text-subtitle1 truncate"
        ...
        <q-card-actions>
          <q-icon
            ...
            size="19px"
            v-if="mediaItem.inserted_at"
          />
          <span>
            {{
              DateTime.fromISO(mediaItem.inserted_at).toLocaleString(DateTime.DATE_MED)
            }}</span
          >
        </q-card-actions>
      </q-card>
